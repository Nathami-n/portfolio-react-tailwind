  ...
  return (
    <div className='w-100 h-screen flex flex-col justify-center text-center'>
      ...
      <span className='flex justify-center gap-5 mt-4 text-[#021841fa]'>
        <a href= "https://www.linkedin.com/in/nathan-george-mi" target='_blank' rel='noreferrer'><GrLinkedin size={30}/></a>
        <a href=""> <GrTwitter size={30} /> </a>
        <a href="https://github.com/Nathami-n" target='_blank' rel='noreferrer'> <GrGithub size={30}/> </a>
      </span>
    </div>
  )
}
