  ...
  return (
    <section className="h-screen max-md:p-6">
      <div className=" flex flex-col items-center  mt-8 gap-11">
        <div className=" w-[90%] h-auto bg-bgcard rounded-2xl  border border-white/20 flex flex-col justify-center items-center">
          <img
            src="/public/nate.svg"
            alt="Hero Image"
        ...
        <div className="text-white h-auto w-[90%] gap-10 bg-bgcard rounded-2xl flex flex-col p-8 justify-center items-center">
